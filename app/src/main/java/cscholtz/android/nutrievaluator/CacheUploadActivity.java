...
public class CacheUploadActivity extends AppCompatActivity {
    ...
    private String sexo;
    private String edad;
    private Float[] medidas = new Float[2];/*peso,talla*/
    private Integer[] pliegues = new Integer[4];/*tricipital,bicipital,suprailiaco,subescapular*/
    private Float[] circunferencias = new Float[4]; /*cintura,cadera,braquial,carpo*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button startButton = (Button) findViewById(R.id.startButtonCache);
